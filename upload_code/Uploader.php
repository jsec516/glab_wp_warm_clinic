...
class FileUpload {
    ...
    private function fixDir($dir) {
        ...
        if(!file_exists($file_dir. DIRECTORY_SEPARATOR . $dir . DIRECTORY_SEPARATOR))
            mkdir($file_dir. DIRECTORY_SEPARATOR . $dir . DIRECTORY_SEPARATOR);
        return $file_dir. DIRECTORY_SEPARATOR . $dir . DIRECTORY_SEPARATOR;
    }
