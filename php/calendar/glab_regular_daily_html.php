...
class glab_regular_daily_html {
	...
	static function generate_calendar($args) {
		...
		$content=self::draw_calendar($args);
		return $content;
	}
	...
	static function get_daily_room_chart($roomArr,$dates,$time1,$time2){
		...
		$top=0;
		$bottom=0;
		$color=array('#483D8B','#228B22','#CD2626','#FFC125','#FF4500');
		$g=0;
	...
	static function draw_calendar($args){
		...
		$content.='<div id="hours_div" style="">
	<div class="autoGrow">
	...
	<div class="autoGrow" style="margin-bottom:15px;">
				<div class="autoGrow">
					<div style="border:0px;width:5.3%; padding:0 0 0 0; background:none repeat scroll 0 0 #717171; color:#fff; height:28px; font-weight:bold; border-bottom: 1px solid #999999;border-right: 0px solid #999999;" class="fl"><div style="margin:5px 0 0 0;">TIME</div></div>';
		$i=1;
