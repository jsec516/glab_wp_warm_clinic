...
class glab_appointment_form 
{
	static function add($args) {
		...
		$msg .= 						'</select>
					            ...
					            <tr class="type1">
									...
									<td style="padding-bottom:20px;">
										<input type="text" value="" autocomplete="off" id="app_last_name2"  name="app_last_name" class="lastName"  style="width:243px;" ><div id="lA" style=" left: 242px !important; position: absolute; top: 509px !important; width: 245px;visibility:hidden;"  class="ac_results lastAutoComplete"  ><ul style="max-height: 180px; overflow: auto;"></ul></div>
									</td>
					            </tr>
            					<tr id="uname1" style="display:none;" class="type1 user-elem1">
									<th style="padding-bottom:20px;">User Name:</th>
									<td style="padding-bottom:20px;"> 
										<input type="text" id="cus_username1" name="cus_username" class="" style="width:250px;" autocomplete="off" />
									</td>
								</tr>
            					<tr id="pwd12" style="display:none;" class="type1 user-elem1">
									<th style="padding-bottom:20px;">Password:</th>
									<td style="padding-bottom:20px;"> 
										<input type="password" id="cus_password12" name="cus_password" class="" style="width:240px;" autocomplete="off" />
									</td>
					            </tr>
					            <tr id="pwd11" style="display:none;" class="type1 user-elem1">
					                <th style="padding-bottom:20px;">Confirm Password:</th>
									<td style="padding-bottom:20px;"> 
										<input type="password" id="cus_password11" name="cus_password1" class="" style="width:240px;" autocomplete="off" />
					                </td>
					            </tr>
					            <tr id="email1" style="display:none;" class="type1 user-elem1">
									<th style="padding-bottom:20px;">E-mail:</th>
									<td style="padding-bottom:20px;"> 
										<input type="text" id="cus_email1" name="cus_email" class="email" style="width:250px;" autocomplete="off" />
									</td>
					                <div id="eA" style=" left: 531px !important;  position: absolute !important;  top: 780px !important; width: 245px !important; visibility:hidden;" class="ac_results emailAutoComplete1"><ul style="max-height: 180px; overflow: auto;"></ul>
									</div>
								</tr>
				                <tr id="phone1" style="display:none;" class="type1 user-elem1">
				                    <th style="padding-bottom:20px;">Phone:</th>
				                    <td style="padding-bottom:20px;"> 
										<input type="text" id="cus_phone1" name="cus_phone" class="" style="width:250px;" autocomplete="off" />
									</td>
								</tr>
								...
								if (self::is_empty_day ( $year . '-' . $month . '-' . $day )) {
									$msg .= 
								'<tr id="mark_day_off" class="type2 type3" style="display:none;">
						            <th>&nbsp;</th>
									<td style="padding-bottom:20px;">
	...
	static function edit($args) {
		...
		<tr id="break_from"  style="display:none;" class="type2 type3">
                    ...
                    <td style="padding-bottom:20px;">
			<select id="break_st_box" name="break_st_box">
                            <option value="">--select time--</option>' . self::getClinicHours ( $month, $day, $year ) . '</select>
                    </td>
		</tr>
                <tr id="break_to" style="display:none;" class="type2 type3">
                    <th style="padding-bottom:20px;">Break To:</th>
	...
	<tr>
		<td><?= $row['pt_comments']; ?></td>
	</tr>
	<tr>
		<th>Practitioner's Note</th>
	</tr>
	<tr>
		<td><?= $row['dr_comments']; ?></td>
	</tr>
...
<div
	style="margin-top: 70px; text-align: center; width: 510px; height: 501px; margin-left: 235px; border: 1px solid #aaaaaa;">
            <?php
		...
		?>
            <table
		style="width: 100%; text-align: center; margin-top: 20px; margin-bottom: 26px;"
		class="tblDetails">
		<tr>
			<td style="text-align: right; width: 250px; padding: 10px;"><span
				style="padding-right: 50px; font-weight: bold;">Patient</span></td>
			<td style="text-align: left;"><?= $row['patient_name']; ?>&nbsp;</td>
		</tr>
		<tr>
			<td style="text-align: right; width: 250px; padding: 10px;"><span
				style="padding-right: 50px; font-weight: bold;">Practitioner</span></td>
			<td style="text-align: left;"><?= $row['practitioner_name']; ?>&nbsp;</td>
		</tr>
		<tr>
			<td style="text-align: right; width: 250px; padding: 10px;"><span
				style="padding-right: 50px; font-weight: bold;">Treatments</span></td>
			<td style="text-align: left;"><?= $row['treat_name']; ?>&nbsp;</td>
		</tr>
		<tr>
			<td style="text-align: right; width: 250px; padding: 10px;"><span
				style="padding-right: 50px; font-weight: bold;">Appointment Date</span></td>
			<td style="text-align: left;"><?= $row['app_date']; ?>&nbsp;</td>
		</tr>
		<tr>
			<td style="text-align: right; width: 250px; padding: 10px;"><span
				style="padding-right: 50px; font-weight: bold;">Appointment Time</span></td>
			<td style="text-align: left;"><?= $row['app_time']; ?>&nbsp;</td>
		</tr>
		<tr>
			<td style="text-align: right; width: 250px; padding: 10px;"><span
				style="padding-right: 50px; font-weight: bold;">Contact with</span></td>
			<td style="text-align: left;"><?= ($row['reminder_type'] == '1') ? "Email" : "Phone"; ?>&nbsp;</td>
		</tr>
		<tr>
			<td style="text-align: right; width: 250px; padding: 10px;"><span
				style="padding-right: 50px; font-weight: bold;">Patient's Comment</span></td>
			<td style="text-align: left;"><?= (trim($row['pt_comments']) != '') ? $row['pt_comments'] : 'N/A'; ?>&nbsp;</td>
		</tr>
		<tr>
			<td
				style="text-align: right; width: 250px; vertical-align: top; padding: 10px;"><span
				style="padding-right: 50px; font-weight: bold;">Practitioner's Note</span></td>
			<td style="text-align: left;"><?= (trim($row['dr_comments']) != '') ? $row['dr_comments'] : 'N/A'; ?></td>
		</tr>
