...
class dial_twilio {
    ...
    public function make_call($call=TRUE, $dial_url='', $to_number='', $voice_type='man') {
        if ($call) {
            ...
            $result = $twilio->request('2010-04-01/Accounts/' . $this->_account_sid . '/Calls', 'POST', array('From' => $this->_from_phone, 'To' => $to_number, 'Url' => $dial_url . '&voice_type=' . $voice_type));
        }
    }
