(function($) {
    ...
    $.fn.glab_sync = function(options) {
        ...
        var addPollField = function(e) {
            ...
            var poll_content = "<tr id=\"poll_" + poll_number + "\"><td>&nbsp;</td><td style=\"padding:5px 0 0 200px;\"><div style=\"position:relative;\"><input type=\"text\" style=\"padding-right:30px;\" id=\"poll_for_text_" + poll_number + "\" name=\"format_text[]\" placeholder=\"Poll Field\" value=\"Poll Field\" class=\"field_box\" ><div class='remove-elem' data-target_id='poll_"+poll_number+"' id=\"close_for_msg\" style=\"margin-left:-25px;width:20px;display:inline;cursor:pointer;\"><img style=\"margin-bottom:-3px;\" alt=\"x\" src=\"" + glab_asset_url + "/images/cancel.png\"></div></div></td></tr>";
